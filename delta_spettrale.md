...
$$\Gamma = \frac{1}{2} \operatorname{Tr} \log \left( \frac{\Delta}{\mu^2} \right)$$
...
$$\int d\lambda \, \rho(\lambda) \frac{\lambda}{\lambda(1+c\delta_*) + \Lambda_{\mathrm{SP}}^2} = 0$$
...
$$\boxed{\delta_* \sim \frac{1}{c} \left( \frac{\langle \lambda \rangle}{\Lambda_{\mathrm{SP}}^2} - 1 \right)}$$

Usando lo spettro del coset si ottiene $\delta_* \approx 0.6$, coerente con $0.633$.
