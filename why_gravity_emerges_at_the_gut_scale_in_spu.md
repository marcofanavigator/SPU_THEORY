# Why Gravity Emerges at the GUT Scale in SPU

## Abstract

In the SPU framework, gravity is not assumed as a fundamental interaction but emerges dynamically from the same fermionic structure responsible for gauge interactions. This document explains why the **natural emergence scale of gravity in SPU is the GUT scale**, not the Planck scale, and why the observed Planck mass arises only after infrared dressing. The result is conceptually consistent with induced-gravity paradigms and does not require fine tuning.
...
## 2. Induced Gravity Mechanism

In SPU, gravity is induced in the Sakharov sense: integrating out fermionic fluctuations generates an effective Einstein–Hilbert term.
...
## 3. Why the UV Cutoff Is the GUT Scale
...
1. Gauge couplings converge dynamically at this scale.
...
## 5. Why the Observed Planck Mass Is Larger
...
- geometric coarse-graining of the emergent background.
...
SPU predicts gravity to be intrinsically linked to gauge unification, not an independent fundamental input.

---

## 8. Conclusion

In SPU, gravity emerges dynamically at the GUT scale because:

- fermionic degrees of freedom are finite and unified,
- the UV cutoff is physically fixed by gauge dynamics,
- gravitational strength is subsequently enhanced by IR effects.

The Planck mass is thus an emergent, infrared quantity rather than a fundamental scale.

This places SPU among a small class of theories where gravity, gauge unification, and fermionic structure are deeply connected.
