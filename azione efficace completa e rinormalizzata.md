...
$$
\boxed{\Gamma[g,\delta] = \frac{1}{2}\operatorname{Tr}\log\left(\frac{\Delta_{E_7/SU(8)}(\delta,g)}{\mu^2}\right)}
$$
...
$$
\operatorname{Tr}(e^{-t\Delta}) = \frac{1}{(4\pi t)^2} \int d^4x \sqrt{-g} \left[ a_0 + a_2 t + a_4 t^2 + \dots \right]
$$
