...
$$
M_e M_e^\dagger = m_e^2 \left[ \mathbb{I} + \gamma \begin{pmatrix} 
0 & 0 & 0 \\ 
0 & 1 & 0 \\ 
0 & 0 & 2 
\end{pmatrix} + \mathcal{O}(\gamma^2) \right], \quad \gamma = \frac{(1-\delta_*)^2}{4}
$$
...
* $\sin^2\theta_{12} = \dfrac{|(U_{\text{PMNS}})_{e2}|^2}{1-|(U_{\text{PMNS}})_{e3}|^2}$
