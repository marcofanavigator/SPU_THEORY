# Geometric Postulate: Why E₇/SU(8)?

## Abstract
The SPU framework is built upon a topological field defined on a compact symmetric space. Among all possible candidates, the coset space $E_7/SU(8)$ plays a distinguished role. This choice is not arbitrary but follows from a set of minimal and physically motivated selection criteria.

## Selection Criteria

### (R1) Compactness and Finiteness
The space must be compact to yield:
...
## Why E₇/SU(8) is Unique

The coset $M = E_7/SU(8)$ satisfies all SPU requirements simultaneously:
...
Even if one starts from a more general background, SPU suggests that any geometry satisfying (R1-R5) flows effectively toward the universality class of $E_7/SU(8)$.

In this sense, $E_7/SU(8)$ is not merely a choice, but an **attractor** in theory space.

## Conclusion
The choice of $E_7/SU(8)$ in SPU follows from a **geometric selection principle** based on finiteness, rigidity, fermionic compatibility, and maximal but controlled capacity. Within the space of known symmetric geometries, $E_7/SU(8)$ emerges as the **unique viable background** for the SPU framework.