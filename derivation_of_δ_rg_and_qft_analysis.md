...
\[
\mathcal L_{\text{int}} = g\,\Phi\,\bar\Psi^\star \Psi^\star,
\]
...
\[
\Pi_\Phi(p^2)
= g^2 \int \frac{d^4 k}{(2\pi)^4}
\frac{\mathrm{Tr}[(\slashed k)(\slashed k + \slashed p)]}{k^2 (k+p)^2}.
\]
...
\[
M_{\Phi,\mathrm{eff}}^2(\mu)
= M_\star^2 + \frac{g^2}{8\pi^2}\,\mu^2,
\]
...
M_{\mathrm{eff}}^2(\mu)
\simeq
\frac{g^2\,\mu^2}{M_{\Phi,\mathrm{eff}}^2(\mu)}.
\]
...
## 7. Explicit expression for \(\delta\)
...
\delta(\mu)
= \frac{g^2}
{M_\star^2/\mu^2 + g^2\left(1 + \frac{1}{8\pi^2}\right)}.
}
\]
